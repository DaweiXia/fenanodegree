...
5. Compress and resize pizzeria.jpg.
...
#####Here is my optimizations
1. Create 48 movers not 200 when load the page.
...
4. Add backface-visibility: hidden to mover to force it stay on its own layer.

5. Move mover selector out of the function updatePositions, because we only need to pick movers once.

6. Pick all randomPizzaContainers once.
...
12. Optimize updatePositions by getting the length of items array once in the for loop.
...
15. Optimize sliding pizzas generator by creating variable elem outside the for loop.
